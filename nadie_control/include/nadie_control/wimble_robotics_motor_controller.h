#ifndef __WIMBLE_ROBOTICS_MOTOR_CONTROLLER_MOTOR
#define __WIMBLE_ROBOTICS_MOTOR_CONTROLLER_MOTOR
...
class WimbleRoboticsMotorController : public MotorController {
public:
	...
	WimbleRoboticsMotorController(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

	~WimbleRoboticsMotorController();
